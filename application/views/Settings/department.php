	...
	<div class="content-wrapper">
	    <nav aria-label="breadcrumb">
	      <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
	        ...
	        <li class="breadcrumb-item active" aria-current="page"><span><i class="mdi mdi-account-multiple-outline"></i>Department</span></li>
	      </ol>
	    </nav>
    <div class="row">
      ...
      <div class="card-body test-card">
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom pb-3 mb-3">
            ...
            <div class="mt-3 mt-md-0">
              <button class="btn btn-primary btn-rounded btn-sm" id="add_button" data-toggle="modal" data-target="#departmentModal"><i class="mdi mdi-account-plus "></i> New Department</button>
            </div>
        </div>
        <div class="row">
          <div class="col-12">
                ...
                <tbody id="showdata">
                  <?php
                        foreach ($records as $r) {
                          ...
                          echo '<td><button type="button" name="update" id="'.$r->departmentID.'" class="btn btn-outline-primary item-edit" data-target="#departmentModal">View</button></td>' ;
                        }
                      ?>
                </tbody>
              </table>
...
<div class="modal fade" id="departmentModal" role="dialog" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
            <div class="col">
              <label for="description">Type of Department</label>
